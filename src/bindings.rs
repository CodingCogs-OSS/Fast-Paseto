//! Python binding functions for fast-paseto
//!
//! This module contains all the standalone Python functions exposed by the library,
//! including token encoding/decoding, key generation, and PASERK operations.
//! These functions provide the module-level API for simple use cases.
...
use crate::{PasetoKeyError, PasetoValidationError};
...
///     32
#[pyfunction]
pub fn generate_symmetric_key(py: Python<'_>) -> PyResult<Py<PyBytes>> {
...
///     32
#[pyfunction]
pub fn generate_keypair(py: Python<'_>) -> PyResult<(Py<PyBytes>, Py<PyBytes>)> {
...
///     True
#[pyfunction]
pub fn to_paserk_local(key: &[u8]) -> PyResult<String> {
    if key.len() != 32 {
        return Err(PasetoKeyError::new_err(format!(
...
///     True
#[pyfunction]
pub fn to_paserk_secret(key: &[u8]) -> PyResult<String> {
    if key.len() != 64 {
        return Err(PasetoKeyError::new_err(format!(
...
///     True
#[pyfunction]
pub fn to_paserk_public(key: &[u8]) -> PyResult<String> {
    if key.len() != 32 {
        return Err(PasetoKeyError::new_err(format!(
...
///     True
#[pyfunction]
pub fn from_paserk(py: Python<'_>, paserk: &str) -> PyResult<(String, Py<PyBytes>)> {
...
///     True
#[pyfunction]
pub fn generate_lid(key: &[u8]) -> PyResult<String> {
    use crate::key_manager::PaserkId;
...
///     True
#[pyfunction]
pub fn generate_sid(key: &[u8]) -> PyResult<String> {
    use crate::key_manager::PaserkId;
...
///     True
#[pyfunction]
pub fn generate_pid(key: &[u8]) -> PyResult<String> {
    use crate::key_manager::PaserkId;
...
///     True
#[pyfunction]
pub fn local_wrap(key: &[u8], wrapping_key: &[u8]) -> PyResult<String> {
    if key.len() != 32 {
        return Err(PasetoKeyError::new_err(format!(
...
///     True
#[pyfunction]
pub fn secret_wrap(secret_key: &[u8], wrapping_key: &[u8]) -> PyResult<String> {
...
///     64
#[pyfunction]
pub fn ed25519_from_pem(py: Python<'_>, pem: &str) -> PyResult<Py<PyBytes>> {
...
///     32
#[pyfunction]
pub fn ed25519_public_from_pem(py: Python<'_>, pem: &str) -> PyResult<Py<PyBytes>> {
